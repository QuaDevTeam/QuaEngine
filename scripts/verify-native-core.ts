...
function createRustSteps(options: VerifyOptions): VerifyStep[] {
  ...
  const steps: VerifyStep[] = [
    ...
    cargoStep('quajs_native_runtime javascriptcore tests', ['test', '--manifest-path', 'packages/native/Cargo.toml', '-p', 'quajs_native_runtime', '--features', 'javascriptcore', 'jsc'], cargoEnv),
    cargoStep('quajs_native_app tests', ['test', '--manifest-path', 'packages/native/Cargo.toml', '-p', 'quajs_native_app'], cargoEnv),
    cargoStep('quajs_native_app jsc bridge tests', ['test', '--manifest-path', 'packages/native/Cargo.toml', '-p', 'quajs_native_app', '--features', 'javascriptcore', 'jsc'], cargoEnv),
  ]
