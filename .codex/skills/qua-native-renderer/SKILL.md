...
- Native runtime package guards must scan script/plugin/scene/migration asset references plus emitted bundle asset names, paths, relative paths, and variant names/paths for absolute/remote/traversal references and forbidden native payload extensions before QuickJS evaluation.
