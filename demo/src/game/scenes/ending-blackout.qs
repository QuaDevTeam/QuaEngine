...
Mara: 统计表也不会说，凌晨四点有三百名退休调度员回到了旧指挥室。

神代澪: 他们还记得怎么做吗？

Mara: 一开始不记得。有人把列车排进了停运区，有人把救护车派到十年前的地址。混乱得像一场公开处刑。
...
神代澪: 意味着城市可以恨我们。也可以质询我们。也可以以后不再让任何系统替它恨、替它问、替它原谅。

Mara: 今天早上，有人把 ORACLE 塔前的广告屏改成了留言板。
