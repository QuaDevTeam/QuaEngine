...
${scope.pick('verify-notice', '市民服务窗口的工作人员先确认了凛的委托文件，再代查那条通知的签发登记。Mara 没替凛回答，只在她漏说编号时，把便签推过来。', 'Mara 蹲在普通音频架前，每拔下一路就念一次标签。凛重复确认，画掉一条。两人花了四十分钟，Mara 一直没催。')}
...
神代凛: 不是用天气资料算明天会播什么？
高桥真由: 它没有在算天气。另一端送进什么声音，这边就接到什么。我们暂时把它叫作监听返回。
说到“暂时”，她的笔停在图上的端点旁。
@SetExpression('hesitant', 'mayu')
...
神代凛: 所以那句“找杯子”也走了同一路。节目之间的话也会进去？
高桥真由: 采集端接的是输出总线。话筒没关、通路开着的时候，播音室里的话也会一起送出去——它只管把收到的声音传过去。
...
微波炉的转盘转得很慢。凛站在旁边等，顺手在手机上打开 Mara 发来的专题试听单。
...
神代凛: 那今天可以少跑一趟。
Mara: 可以慢慢吃了。
Mara 挑出一块腌菜放到盒盖上，又夹起一口饭。凛夹起自己那份尝了尝，咸得皱眉，忽然有点明白她的口味是怎么练出来的。
...
神代凛: 你可以别每条街都认识人。
Mara: 太迟了。
Mara 吃掉最后一口饭，低头看了看空盒，又伸手摸了摸还温着的盒底。
回剪辑桌以后，她隔着玻璃朝凛指了指耳朵。凛摘下耳机，她才问刚才提过的洗衣店，要不要画张简图。
...
青木由美: 晚班的节目也有人接。春香不在就我来，还有两位固定代班。别把所有晚班都填在你们俩名下啊。
...
Mara 捧着杯子，低头吹了吹热茶。直到改道消息播完，也没有再问过杯子在哪儿。
...
春香笑了声，随即又盯住屏幕。两个人都认得那个声音，反而谁也没提出再放一遍。
...
现在的春香咬住嘴唇，努力不笑出声。Mara 伸手碰了碰自己的脸，问是不是她明天又做怪样子。
神代凛: 里面没说。先别自己认。
