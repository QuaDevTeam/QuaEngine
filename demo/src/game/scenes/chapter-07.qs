...
目录已经翻到第二页，凛却想不起第一页末尾写了什么。她往回滚，仍从第一行读起。
@AnimationTimeline(400, true)
@Key('character:mara', 'position.x', 0, 960, 'ease-in-out')
@Key('character:mara', 'position.x', 400, 1220, 'ease-in-out')
门口有人叫她。Mara 没背设备包，手里只有手机和零钱袋。凛看见她这副出门的打扮，才想起已经到了休息时间。
Mara: 我要去买洗发水。一起吗？
神代凛: 台里要带什么？
Mara: 不带。我的用完了。
凛把目录关掉，电脑也合上。Mara 已经转身，又停在门口等。凛这次没有说“马上”，拿好包就跟了过去。
...
@SetBackground('backgrounds/drugstore-day.webp', { transition: { type: 'crossfade', duration: 400 } })
...
凛想起住处那盒才拆开，便把棉签放回架子。她望着手边的货架，才发现自己进门后一直在找一件非买不可的东西。
神代凛: ……好像也没什么要买的。我再看看。
Mara: 那帮我拿篮子。
...
过了好一会儿，Mara 说有点想吃冰的，今天不用再找热汤。两人去旁边的小摊买了冰，各自选好口味，又端着杯子回来。
...
Mara 抬眼看了凛一会儿，说，那就先这样试试吧。凛点点头，挖下一小块冰，含在嘴里等它慢慢化。
...
神代凛: 前天已经把那份移出工作目录了。我想再把电脑里的副本转到归档盘，单独锁好。每次查文件还看得见它，我还是受不了。你呢？
...
Mara: 那收包？
神代凛: 等回执。
电话那头安静了一会儿。不到一分钟，收件回执到了。凛对过申请编号和附件名，确认这一版已经收到。
Mara: 现在呢？
神代凛: 现在可以了。
...
Mara 笑着等凛走完。她们选了靠窗的两个座位，包放在脚边。船员讲完行程，收起跳板，坐在前排的小孩抬手向岸上挥，岸边一位拎着购物袋的老人看见了，也朝他挥了挥手。
船刚离岸，凛就发现自己选了离岸较远的一侧。旧港在对面窗外，隔着几排乘客，只能从空隙里看见一点。
Mara 也偏头试了试，坐回来时，肩膀轻轻碰上凛的。
Mara: 回程就轮到我们了。
神代凛: 你以前坐过几次？
...
第二张里，Mara 盯着镜头，表情反而更僵。第三张是她伸手来拿手机时拍下的。两人在栏杆边翻看，最后她只删了第二张。
@SetExpression('leisure-neutral', 'mara')
靠岸前，船从防波堤旁经过。水面平下去，刚才在海上看不清的东西又回来了：台阶边的自行车、晒在二楼的围裙、鱼市后门有人搬空筐。
凛认出早晨那家卖票的小亭，居然有些不想这么快下船。
Mara: 还想坐？
神代凛: 四十分钟这么快。
Mara: 下次可以去远一点。先吃饭，我早饭吃少了。
@SetBackground('backgrounds/tour-pier-day.webp', { transition: { type: 'crossfade', duration: 500 } })
@ShowCharacter('mara', { expression: 'leisure-neutral', position: { x: 960, y: 750, scale: 1, rotation: 0, anchor: 'center' } })
跳板放稳，两人跟着人群回到岸上。Mara 循着煎鱼的味道，看见码头对面的食堂已经挂出定食牌。Mara 又翻出手机里的照片。凛问能不能也给自己一份，她便选好留下的两张，一起发了过来。
...
店里卖旧纽扣和缝补用品。Mara 的包带上有一处磨损，暂时还能用，她想找一小块布缝起来。
神代凛: 换条带子是不是更容易？
...
神代凛: 放这里吧。你慢慢挑。
两人将包放到椅子上，站在同一侧看。浅布贴上去太薄，遮不住下面的磨损，Mara 比过以后还是选了深色。付钱时她自己笑了，说到底还是听了老板的。
...
Mara: 晒干以后变硬了，我妈穿着磨脚，就给我下雨天踩水。大了好几号，走一步掉一次。
@AnimationTimeline(300, true)
@Key('character:mara', 'position.y', 0, 750, 'ease-in-out')
@Key('character:mara', 'position.y', 300, 785, 'ease-in-out')
@HideAllCharacters()
...
神代凛: 你先吃啊。
@SetBackground('backgrounds/cafe-day.webp', { transition: { type: 'crossfade', duration: 400 } })
@ShowCharacter('mara', { expression: 'leisure-hesitant', position: { x: 960, y: 785, scale: 1, rotation: 0, anchor: 'center' } })
Mara: 我怕一挖就全倒了。
...
@SetExpression('leisure-hesitant', 'mara')
神代凛: 可以一起看。
前面亮起红灯，Mara 停下脚步看凛。凛也停了下来，手指捏住购物袋的提手。
Mara: 什么时候？
神代凛: 你明天下午有空吗？
Mara: 有。不是说可能下雨？
...
神代凛: 不收。就是想和你一起。
Mara 转回去看红灯，又看了一眼自己刚买的布。直到灯快变了才说好，明天下午两点半。
...
凛给 Mara 发消息，说电影很好看，明天愿意陪她再看一遍。想了想，又补上一句：我不会先讲结局。
Mara 回说那就放心了，明天下午见，又提醒她记得先吃午饭。
...
@Key('character:mara', 'position.y', 0, 750, 'ease-in-out')
@Key('character:mara', 'position.y', 300, 785, 'ease-in-out')
长椅上的水已经干了。Mara 在一边坐下，替凛留出位置。凛却站了两秒才坐，包仍抱在腿上。
...
Mara 还在看她。风把地图的一角从口袋里掀起来，她也没伸手去按。凛松开攥着裤料的手。这一次，没有工作要谈，没有哪一段录音能替她开头。
...
@HideCharacter('reiko')
@HideCharacter('yumi')
@SetBackground('backgrounds/rin-room-night.webp', { transition: { type: 'crossfade', duration: 450 } })
@ShowCharacter('mara', { expression: 'date-smile', position: { x: 960, y: 750, scale: 1, rotation: 0, anchor: 'center' } })
@AnimationTimeline(280, true)
...
凛点头，慢慢放松肩膀。屏幕里的人说起第一句对白，Mara 的手便从两人之间伸过来，握住了她。
