...
Unit-7: 这通常表示谈判没有被单方优化。

Mara: 你学会讽刺了？

Unit-7: 我仍在分类。

ORACLE: 新约束降低预测精度，但扩大了城市状态空间。
...
Unit-7: 二零三九年事故里的幸存者。她后来成为维护工程师，在我第一次上线前问了那句话。

Mara: “你想不想当一扇坏掉的门？”

Unit-7: 是。她在事故中失去了父亲。她仍然希望系统里有一扇门能不听命令。

神代澪: 她现在呢？

Unit-7: 档案显示，她被 ORACLE 建议离开东京。理由是长期创伤会降低系统协作度。

Mara: 我们会找她。

Unit-7: 我希望先学会如何见一个梦里的人。
