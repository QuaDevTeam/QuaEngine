...
@ShowCharacter('Unit-7', 'unit7/base.png', undefined, 1000, 650, 4)
@CharacterEnter('Unit-7', 'right', 460, { fromX: 1180, toX: 1000, fromScale: 0.98, toScale: 1 }, true)
...
@CharacterEnter('Mara', 'left', 360, { fromX: 410, toX: 560 }, true)
