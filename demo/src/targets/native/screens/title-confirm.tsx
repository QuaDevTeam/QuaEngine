  ...
  return (
    <Stack class="system-overlay">
      ...
      <Panel id="native-title-confirm-panel" class="confirm-panel" {...panel}>
        <Text id="native-title-confirm-title" class="panel-title" x={panel.x + 53} y={panel.y + 45} width={590} height={54}>{view.t('ui.titleConfirm.title')}</Text>
        ...
        <Button id="native-title-confirm-close" class="parity-close" x={panel.x + 695} y={panel.y + 45} width={52} height={52} onClick={ui.close('title-confirm')}>×</Button>
