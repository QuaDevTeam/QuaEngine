...
<style>
  ...
  :global(.nw-button:focus-visible) {
    outline: none;
    box-shadow: none;
  ...
  :global(.nw-button-icon) {
    flex: 0 0 auto;
    width: var(--nw-icon-button-size, 36px);
    height: var(--nw-icon-button-size, 36px);
    min-width: var(--nw-icon-button-size, 36px);
    min-height: var(--nw-icon-button-size, 36px);
    padding: 0;
  }
</style>
