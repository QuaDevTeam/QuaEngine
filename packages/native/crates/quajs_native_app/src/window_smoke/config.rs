...
pub const WINDOW_DEV_FRAME_PATH_ENV: &str = "QUA_NATIVE_RENDERER_WINDOW_DEV_FRAME_PATH";
pub const WINDOW_DEV_INTENT_PATH_ENV: &str = "QUA_NATIVE_RENDERER_WINDOW_DEV_INTENT_PATH";
