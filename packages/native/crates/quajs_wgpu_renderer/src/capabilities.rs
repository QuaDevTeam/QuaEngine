...
pub fn native_wgpu_capabilities() -> Vec<RendererCapability> {
    vec![
        ...
        capability(
            "native-wgpu.background-transition@1",
            &["background.preparationId", "background.shaderTransition"],
            &["background/ready"],
            &["images"],
            &[],
            &[],
        ...
        capability(
            "native-wgpu.asset-loading@1",
            &["view.plugins.asset-loading.preparation"],
            &["asset-loading/renderer-progress"],
            &["images", "characters"],
            &[],
            &[],
            "reject-package",
        ...
        capability(
            ...
            &[],
            &["images", "characters"],
            &["filter", "object-fit", "object-position", "opacity"],
            &["Image"],
            "render-empty",
        ),
        capability(
