...
pub(in super::super) fn json_frame_with_malformed_surface_node_children_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
...
pub(in super::super) fn json_frame_with_malformed_surface_root_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
