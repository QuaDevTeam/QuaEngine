...
pub(super) fn json_frame_with_negative_layout_width_input() -> &'static str {
    r#"
    {
...
pub(super) fn json_frame_with_inverted_layout_aspect_interval_input() -> &'static str {
    r#"
    {
...
pub(super) fn json_frame_with_oversized_container_dpr_input() -> &'static str {
    r#"
    {
...
pub(super) fn json_frame_with_negative_safe_area_inset_input() -> &'static str {
    r#"
    {
      "container": {
        "width": 1600,
...
pub(super) fn json_frame_with_oversized_background_layer_z_index_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
...
pub(super) fn json_frame_with_oversized_character_layer_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
...
pub(super) fn json_frame_with_oversized_overlay_stack_priority_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
...
pub(super) fn json_frame_with_oversized_ui_node_z_index_input() -> &'static str {
    r#"
    {
      "container": { "width": 1600, "height": 1000 },
      "view": {
