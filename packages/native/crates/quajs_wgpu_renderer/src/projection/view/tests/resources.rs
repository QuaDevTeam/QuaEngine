...
fn summarizes_combined_projection_resources_and_packages() {
    ...
    assert_eq!(summary.command_count, 11);
    ...
    assert_eq!(summary.by_plane[&RenderPlane::Safe].command_count, 9);
    assert_eq!(summary.by_package["base"].resource_ref_count, 2);
    assert_eq!(summary.by_package["runtime.dialogue"].command_count, 6);
