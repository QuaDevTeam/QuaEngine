...
describe('QuaScriptParser', () => {
  test('should parse simple dialogue', () => {
  ...
  test('should parse dialogue with decorators', () => {
    const parser = new QuaScriptParser()
    const script = `
      @PlaySound('hello.mp3')
  ...
  test('should parse decorators with multiple arguments', () => {
    const parser = new QuaScriptParser()
    const script = `
  ...
  test('should extract template expressions', () => {
    const parser = new QuaScriptParser()
    const script = `
  ...
  test('should handle action-only decorators', () => {
    const parser = new QuaScriptParser()
    const script = `
