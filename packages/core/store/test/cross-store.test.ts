...
import { commit, createStore, dispatch, QuaStoreManager, useStore } from '../src/index'
  ...
  describe('integration scenarios', () => {
    it('should handle complex cross-store workflows', async () => {
      const authStore = createStore({
        ...
        actions: {
          login: async ({ commit: localCommit }, { username, _password }: { username: string, _password: string }) => {
            // Simulate API call
